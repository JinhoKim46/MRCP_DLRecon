...
class VarNet(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            pools: Number of downsampling and upsampling layers for U-Net.
        """
        super().__init__()

        self.cascades = nn.ModuleList(
            [VarNetBlock(NormUnet(chans, pools)) for _ in
             range(num_cascades)]
        )
    ...
    def forward(
        ...
        return kspace_pred, sens_maps


class VarNetBlock(nn.Module):
    """
    Model block for the variational network.
